...
-- yeah i used the fnfr modules and modified it CRY ABOUT IT!!!!!!!!!!!
-- (idk if i'm allowed to do this honestly)
...
return {
	...
	imagePath = function(path)
		local pathStr = "assets/images/" .. imageType .. "/" .. path .. "." .. imageType
